    ...
    SALA.element = {
        ...
        dark_light_switcher: function() {
            ...
            function toggleDarkMode() {
                var _this   = $( '.dl-switcher' ),
                    body    = $( 'body' ),
                    toddler = _this.find( '.toddler' );
        
                if( _this.hasClass( 'sala-dark-scheme' ) ){
                    var text = _this.find( '.light' ).attr( 'data-text' );
                    toddler.text(text);
                } else {
                    var text = _this.find( '.dark' ).attr( 'data-text' );
                    toddler.text(text);
                }
            ...
            // Attach click event to dark/light mode switcher
            $( '.dl-switcher' ).on( 'click', function(e) {
                e.preventDefault();
                toggleDarkMode();
            });
        
            // Trigger click event to set dark mode on page load
